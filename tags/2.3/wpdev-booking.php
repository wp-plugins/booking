...
function wpdev_bk_define_static() {
    ...
    $version_type = '';
    //if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/wpdev-pro.php')) $version_type = '9.Professional.';
    //if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/wpdev-premium.php')) $version_type = '9.Premium.';
    //if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/wpdev-hotel.php')) $version_type = '9.Hotel.Edition.';
        ...
        function get_dates ($approved = 'all', $bk_type = 1) {
            ...
            if ($approved == 'admin_blank') {
                 $sql_req = "SELECT DISTINCT dt.booking_date
                         ...
                         WHERE  dt.booking_date >= CURDATE()  AND bk.booking_type = $bk_type AND bk.form like '%admin@blank.com%'
...
<p>
        ...
        function print_js_at_footer() {
            if ( ( strpos($_SERVER['REQUEST_URI'],'wpdev-booking.phpwpdev-booking')!==false) &&
                ...
                $dates_and_time_for_admin_blank = $this->get_dates('admin_blank', $bk_type);
...
<script  type="text/javascript">
    ...
    var wpdev_bk_today = new Array(<?php echo  date_i18n('Y') .', '. date_i18n('m').', '. date_i18n('d').', '. date_i18n('H').', '. date_i18n('i') ; ?>); 
...
<div  class="copyright_info" style="">
    <div style="width:580px;height:10px;margin:auto;">
            ...
            <?php
                 ...
                 if( $this->wpdev_bk_pro == false )
                    $support_links = '<div id="support_links">\n\
                        ...
                        <a href="http://onlinebookingcalendar.net/purchase/" target="_blank">'.__('Buy now','wpdev-booking').'</a>\n\
                                      </div>';
                 else
                    $support_links = '<div id="support_links">\n\
                        <a href="http://onlinebookingcalendar.com/faq/" target="_blank">'.__('FAQ','wpdev-booking').'</a> |\n\
        ...
        function settings_menu_top_line() { 
            ...
            if (class_exists('wpdev_bk_premium_plus'))   $version = 'hotel';
                        ...
                        <div class='meta-box-sortables ui-sortable' id="upgrade-box">
                            <div  id="upgrade-box-title" class="postbox gdrgrid"  ><!--div style="float:right;"><a href="#" onmousedown="javascript:document.getElementById('upgrade-box').style.display='none';"><img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/apple-close.png" /></a></div--> <div title="Click to toggle" class="handlediv"><br></div><h3 class='hndle'><span>Upgrade to <?php if ( ($version == 'pro') ) { ?>Premium /<?php } ?> Hotel Edtion versions</span></h3>
                                ...
                                <div class="inside">
                                    ...
                                    <?php if( strpos( strtolower(WPDEV_BK_VERSION) , 'multisite') !== false  ) { $multiv = '-multi'; } else { $multiv = ''; }  ?>
                                    <?php if ( ($version == 'pro') ) { ?>
...
<div id="poststuff" class="metabox-holder">
                ...
                <div class="inside">
                    <form  name="post_option" action="" method="post" id="post_option" >
                        <table class="form-table"><tbody>
                                ...
                                <?php make_bk_action('wpdev_bk_general_settings_start_after_skin') ?>
    ...
    <div style="width:35%; float:left;">
        ...
        <div class='meta-box'>
            <div  class="postbox gdrgrid" > <h3 class='hndle'><span><?php _e('Recomended WordPress Plugins','wpdev-booking'); ?></span></h3>
                <div class="inside">
...
//debuge($_SERVER);
                    ?> <script type="text/javascript">
                     ...
                     if ( strpos($_SERVER['HTTP_REFERER'],'wp-admin/admin.php?') ===false ) { do_action('wpdev_new_booking',$booking_id, $bktype, str_replace('|',',',$dates), array($start_time, $end_time ) ,$sdform ); }
                     die();
