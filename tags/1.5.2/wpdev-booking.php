 ...
 * Range selections by first and last date selections.


= 1.5.2 =
* Professional / Premium / Hotel version features:
  * Rates feature - costs depends from the season. Example: Payment cost calculation depends from the period - July and August the price for a day is € 100,00. From January until March the price is € 50,00 and during April and May the price is € 70,00 and so on.
  * Activate / Deactivate sending of emeils at the Profesional, Premium and Hotel edition version. [visitoremeil] - shortcode (at field "To" of form "Email to "Admin" after booking at site") for sending emeils also to the visitor after booking is made.
  * Added new way of range selections by mouse selection begin and end days of range (in 2 mouse clicks)
  * Optimising of range selections: more correct selections checking on already booked days / times.
...
= 1.5.1 =
* Professional / Premium / Hotel version features:
  * Season avalaibility filter functionality
  * Posibility to set avalaible / unavailable dates inside of calendar

= 1.5 =
 * Professional / Premium / Hotel version features:
  * New version - Booking Calendar Hotel Edition
  * Posibility to set number of items inside of booking resource. For exmaple maximum number of rooms/seats/places/count of visitors of the specific type(booking resource). So days will be availbale untill all rooms (itms) are not reserved.
  * Filter for showing only specific booking from selected items of some booking resource. In practice, for example, its mean that you can see only all bookings of standard (booking resource) room #101 (booking item)
 ...
 * Professional and Premium version features:
  * Improve highlighting of days at range (week) days selections.
 * Features and issue fixings in All versions:
...
function wpdev_bk_define_static() {
    if (!defined('WPDEV_BK_VERSION'))    define('WPDEV_BK_VERSION',  '1.5.2' );                             // 0.1
                    ...
                    <div class="table">
                        <table><tbody>
                                ...
                                <tr class="">
                                    ...
                                    <td class="t i">(<strong><?php _e("filters", 'wpdev-booking'); ?></strong>)</td>
                                    <td class="b options comparision" style="text-align:center;color: green; font-weight: bold;"></td>
                                    <td class="b options comparision" style="text-align:center;color: green; font-weight: bold;">&bull;</td>
                                </tr>
                                <tr>
