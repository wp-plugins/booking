 ...
 * Showing bookings from all booking types at admin panel
 ...
 * Professional and Delux version features:
  ...
  * Setting Time for showing thank you message
...
function wpdev_bk_define_static() {
    if (!defined('WPDEV_BK_VERSION'))    define('WPDEV_BK_VERSION',  '1.3.2' );                                // 0.1
...
if (!class_exists('wpdev_booking')) {
    class wpdev_booking   {
        ...
        function wpdev_booking() {
            ...
            $this->gui_booking = &new wpdev_gui_bk('wpdev-booking',__FILE__,__('Bookings service', 'wpdev-booking'), __('Bookings', 'wpdev-booking'),'');
                ...
                // 'content_' . $this->$prefix . '_' . $type
                                $this->settings['custom_buttons'] = array(
                                            'booking_insert' => array(
                                                'hint' => __('Insertbooking calendar', 'wpdev-booking'),
                                                ...
                                                <div class="wpdev_bk-dialog-inputs">
                                                    ...
                                                    ?>
                                                        <div class="field">
                                                            ...
                                                            <span class="description"><?php _e('Enter type of property for booking.', 'wpdev-booking'); ?></span>
                                                        </div>
                                                    <?php }/**/ ?>
                                                    <div class="field">
                                                        ...
                                                        <span class="description"><?php _e('Enter count of month to show for calendar.', 'wpdev-booking'); ?></span>
                                                    </div>
	...
	function js_escape($text) {
        ...
        function booking_table($approved = 0) {
            ...
            <table class='booking_table' cellspacing="0">
                <tr>
                    <th style="width:70px;"><?php _e('Approved', 'wpdev-booking'); ?></th>
        ...
        function booking_widget_control(){
            ...
            ?>
            <p>
                <label><?php _e('Booking property', 'wpdev-booking'); ?>:</label><br/>
                    <!--input id="calendar_type"  name="calendar_type" class="input" type="text" -->
            ...
            <p>
            <?php printf(__("%sImportant!!!%s Please note, if you show booking calendar (inserted into post/page) with booking calendar widget at the same page, then widget booking calendar will not visible.", 'wpdev-booking'),'<strong>','</strong><br/>'); ?>
            </p>
            <?php  
        }
        ...
        function add_booking_widjet(){
            ...
            wp_register_sidebar_widget('wpdev_booking_widget', __('Booking', 'wpdev-booking'), array(&$this,'show_booking_widget'), $widget_options);
       ...
       // Print     J a v a S cr i p t   &    C S S    scripts for admin and client side.
                                                ...
                                                <table class="form-table"><tbody>
                                                        ...
                                                        <th scope="row"><label for="admin_cal_count" ><?php _e('Count of calendars', 'wpdev-booking'); ?>:</label><br><?php printf(__('at %sadmin%s booking page', 'wpdev-booking'),'<span style="color:#888;font-weight:bold;">','</span>'); ?></th>
                                                            <td><input id="admin_cal_count" class="regular-text code" type="text" size="45" value="<?php echo $admin_cal_count; ?>" name="admin_cal_count"/>
                                                                <span class="description"><?php printf(__('Type your count of calendars %sat admin booking page%s', 'wpdev-booking'),'<b>','</b>');?></span>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <td>
                                                                <select id="start_day_weeek" name="start_day_weeek">
                                                                    ...
                                                                    <option <?php if($start_day_weeek == '4') echo "selected"; ?> value="4"><?php _e('Thusday', 'wpdev-booking'); ?></option>
                                                        ...
                                                        <td><input id="new_booking_title" class="regular-text code" type="text" size="45" value="<?php echo $new_booking_title; ?>" name="new_booking_title" style="width:99%;"/>
                                                                <br/><span class="description"><?php printf(__('Type title of new reservation %safter booking is done by user%s', 'wpdev-booking'),'<b>','</b>');?></span>
                                                            </td>
                                                        </tr>
                                    ...
                                    <div class="inside">
                                        ...
                                        <div class="table">
                                            <table><tbody>
                                                ...
                                                <tr class="">
                                                    <td class="first b" ><?php _e("Multi bookings", 'wpdev-booking'); ?></td>
                                                    <td class="t i">(<?php _e("several bookings on the same date", 'wpdev-booking'); ?>)</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="t options comparision"><?php _e("start", 'wpdev-booking'); ?> $99</td>
                                                </tr>
                                                <tr class="last">
                                                ...
                                                <tr class="last">
                                                    ...
                                                    <td class="t i">(<?php _e("buy Professional verion", 'wpdev-booking'); ?>)</td>
        ...
        function wpdev_booking_activate() {
           ...
           add_option( 'booking_title_after_reservation' , sprintf(__('Thank you for your online reservation request. %s We will make contact to confirm your booking as soon as possible.', 'wpdev-booking'), '<br/>') );
