...
/**/
 ...
 if (1)
             ...
             foreach ($result_structure as $key=>$value) {
                switch ($sort_type) {
                    case 'date':     if ( ! empty($sorted_structure[$value['form']['date']])) $sorted_structure[$value['form']['date'] . (time() * rand()) ] = $value; else $sorted_structure[$value['dates'][0]] = $value;  break;
            ...
            if (count($sorted_structure)>0) {
                ...
                <table class='booking_table' cellspacing="0">
                    <tr>
                        ...
                        <th style="width:15px;"><?php echo $sort_url; ?><?php
                            if (isset($_GET['booking_sort_order'])) {  if ($_GET['booking_sort_order']=='id')  echo 'id_desc';    else echo 'id';  }
                            else echo 'id_desc'; ?>"><?php _e('ID', 'wpdev-booking'); ?></a><?php
                            if ( ($_GET['booking_sort_order']=='id')  )      echo $arr_asc;
                            if ($_GET['booking_sort_order']=='id_desc') echo $arr_desc;
                            ?></th>
...
if (1) {
                        ...
                        <th><?php echo $sort_url; ?><?php
                            ...
                            if ( ($_GET['booking_sort_order']=='date') || (! isset( $_GET['booking_sort_order']) ) ) echo $arr_asc;
