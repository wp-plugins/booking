...
if (!class_exists('wpdev_booking')) {
    class wpdev_booking {
        ...
        function add_new_admin_menu() {
            ...
            // $submenu[plugin_basename( WPDEV_BK_FILE ) . 'wpdev-booking'][0][0] = __('Booking calendar', 'wpdev-booking');
        }
            ...
            <?php if( $this->wpdev_bk_pro !== false ) { ?>
                ...
                function wpdev_bk_ButtonOk() {
                    ...
                    if ((cal_tag == 'booking') || (cal_tag == 'bookingcalendar')) {
                        ...
                        if ( jWPDev("#start_month_active").attr('checked') )
                          text += ' ' + 'startmonth=\''+ jWPDev("#year_start_month").val() +'-'+ jWPDev("#month_start_month").val() + '\'';
                    }
                    text += ']';
                        ...
                        <div id="popup_new_reservation"  style="display:block;width:650px;">
                            ...
                            <div class="field">
                                <div style="float:left;">
                                    ...
                                    <input id="start_month_active"  name="start_month_active" onchange="javascript:if(! this.checked){ jWPDev('select.start_month').attr('disabled', 'disabled'); } else {jWPDev('select.start_month').removeAttr('disabled');}"  type="checkbox"  style="pading:0px;margin:5px;width:auto;"  />
...
<td colspan="2">
 ...
 <li>Independent, seperate configuration of rates, advanced cost management and season availability for each active non super booking admin user </li>
                ...
                <div> <h2> Features. </h2>
                    <ul style="font-size:13px; font-style:normal; list-style:disc inside none; text-shadow:0 0 1px #CCCCCC;">
                        <li>Configuration of <strong>search</strong>, available booking resources. <span style="font-style:italic;">[ <span class="color_hotel" >Hotel Edition only !</span>]</span></li>
