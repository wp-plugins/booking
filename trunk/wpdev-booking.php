 ...
 * Start time is not valid. Probably, this time for selected dates already reserved
      * Start Time (+ possibly End Time) are invalid, probably by requesting time(s) already booked, or already in the past!
...
function wpdev_bk_define_static() {
    if (!defined('WPDEV_BK_VERSION'))    define('WPDEV_BK_VERSION',  '1.4.2' );                             // 0.1
                                    ...
                                    <div class="inside">
                                            <form  name="post_option" action="" method="post" id="post_option" >
                                                <table class="form-table"><tbody>
                                                        ...
                                                        <tr valign="top">
                                                            <th scope="row"><label for="is_dif_colors_approval_pending" ><?php _e('Unavailable days', 'wpdev-booking'); ?>:</label><br><?php _e('', 'wpdev-booking'); ?></th>
