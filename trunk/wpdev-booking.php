...
-----------------------------------------------
= 1.5 =
 * Several Booking calendars skins
...
function wpdev_bk_define_static() {
    ...
    if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/wpdev-probk.php')) { require_once(WPDEV_BK_PLUGIN_DIR. '/include/wpdev-probk.php' ); }
...
if (!class_exists('wpdev_booking')) {
    class wpdev_booking   {
        ...
        function wpdev_booking() {
            ...
            $this->gui_reservation = &new wpdev_gui('wpdev-booking-reservation',__FILE__  ,__('Add booking'), __('Add booking'),'submenu','', __FILE__ . $this->gui_booking->gui_html_id_prefix,0);
            ...
            $this->gui_settings = &new wpdev_gui('wpdev-booking-option',__FILE__  ,__('Booking settings'), __('Settings'),'submenu','', __FILE__ . $this->gui_booking->gui_html_id_prefix,1);
        ...
        function wpdev_booking_activate() {
           ...
           // Create here tables which is needed for using plugin
            ...
            if ( ! $this->is_table_exists('booking') ) { // Cehck if tables not exist yet
                ...
                $simple_sql = "ALTER TABLE ".$wpdb->prefix ."booking ADD form TEXT NOT NULL DEFAULT '' AFTER booking_id";
