 ...
 * User management system. inserting different hotels in website and each one with its form:  so every form should send booking request email to a different address
 ...
 * More advances pricing system: 5 day discount, 
...
function get_form_content ($formdata, $bktype =-1 ) {
    ...
    $return_array =   array('content' => $booking_form_show, 'email' => $email_adress, 'name' => $name_of_person , 'visitors' => $visitors_count   ) ; 
