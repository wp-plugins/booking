 ...
 * send text messages after booking appointments,
 * send reminders via email and text messaging
 ...
 * if the cost is set to  0 , it should not direct to paypal
    ...
    class wpdev_booking {
       ...
       function on_show_page_adminmenu($html_id, $icon, $title, $content_type) {
           ?>
            ...
            <?php   echo '<div class="icon32" style="margin:10px 25px 10px 10px;"><img src="'. WPDEV_BK_PLUGIN_URL . $icon .'"><br /></div>' ; ?>
            ...
            if ( count($result) > 0 ) {
                ...
                <?php
                    foreach ($result as $bk) {
                        ...
                        ?>
                            <tr id="booking_row<?php  echo $bk->booking_id  ?>">
...
<a href="admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-option&tab=main" class="bk_top_menu <?php echo $slct_a; ?>"><?php $title = __('General settings', 'wpdev-booking'); echo $title; if ($slct_a == 'selected') $selected_title = $title; ?></a>
            <?php if ($_GET['tab'] == 'form') { $slct_a = 'selected'; } else { $slct_a = ''; } ?>
<a href="admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-option&tab=form" class="bk_top_menu <?php echo $slct_a; ?>"><?php $title = __('Form fields and content', 'wpdev-booking'); echo $title; if ($slct_a == 'selected') $selected_title = $title; ?></a>
            <?php if ($_GET['tab'] == 'email') { $slct_a = 'selected'; } else { $slct_a = ''; } ?>
<a href="admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-option&tab=email" class="bk_top_menu <?php echo $slct_a; ?>"><?php $title = __('Emails', 'wpdev-booking'); echo $title; if ($slct_a == 'selected') $selected_title = $title; ?></a>

<?php if ( ($version == 'free') || ($version == 'premium') || ($version == 'hotel') ) { ?>
            <?php if ($_GET['tab'] == 'paypal') { $slct_a = 'selected'; } else { $slct_a = ''; } ?>
 <a href="admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-option&tab=paypal" class="bk_top_menu <?php echo $slct_a; ?>"><?php $title = __('Paypal and cost', 'wpdev-booking'); echo $title; if ($slct_a == 'selected') $selected_title = $title; ?></a>
            <?php
 }
if ( ($version == 'free') || ($version == 'hotel') ) {
if ($_GET['tab'] == 'hotel') { $slct_a = 'selected'; } else {$slct_a = '';} ?>
 <a href="admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-option&tab=hotel" class="bk_top_menu <?php echo $slct_a; ?>"><?php $title = __('Booking resources', 'wpdev-booking'); echo $title; if ($slct_a == 'selected') $selected_title = $title; ?></a>
<?php if ($_GET['tab'] == 'filter') { $slct_a = 'selected'; } else {$slct_a = '';} ?>
 <a href="admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-option&tab=filter" class="bk_top_menu <?php echo $slct_a; ?>"><?php $title = __('Season filers', 'wpdev-booking'); echo $title; if ($slct_a == 'selected') $selected_title = $title; ?></a>
<?php
 }
 ?>
 <script>
                    ...
                    <div class="table">
                        <table><tbody>
                                ...
                                <tr class="last">
                                    ...
                                    <td colspan="3" style="text-align:right;font-size: 18px;font-weight:normal;" class="t comparision"> <a  href="http://wpdevelop.com/booking-calendar-professional/" target="_blank"><?php _e("Buy now", 'wpdev-booking'); ?></a> </td>
                                </tr>
