 ...
 * We have selected the fixed date option, so only sat to sat can be booked. However, when you wave the mouse over a week, it highlights the following week (because our Start day is the Sat)...You have to actually put mouse onthe Sat for it to highlight correct week.Can it be fixed so when you wave the mouse anywhere in that week ithighlights it?
