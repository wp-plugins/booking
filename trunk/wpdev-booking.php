                        ...
                        ?>
                            <tr id="booking_row<?php  echo $bk['id']  ?>"  <?php if ($_GET['booking_id_selection'] ==$bk['id']) echo ' class="raw_after_editing" '; ?>  >
                                ...
                                <td <?php echo $alternative_color; ?> >
                                    ...
                                    if( $this->wpdev_bk_pro !== false ) echo "<input type='button' class='button' value='&nbsp;&nbsp;&nbsp;".__('Edit','wpdev-booking')."&nbsp;&nbsp;&nbsp;' onclick='javascript:location.href=&quot;admin.php?page=".WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ."wpdev-booking-reservation&booking_type=".$bk['booking_type']."&booking_id=".$bk['id']."&quot;;'>";
