...
2. Adding new reservation, from admin panel
3. Showing 2 monthes in row at inline calendar
4. Adding booking form into post or page, using new booking button at TinyMCE toolbar
5. Custom Booking form with captcha and legend (custom forms are support at paid versions)
6. General booking settings page
7. Customization booking form fields and view at booking tables
8. Customization emails, which are sending after new booking is done and after approval or cancelation of booking. Also for payment request or after modification of booking. (Emails template customization are support at paid versions)
9. Example of email, which is sending to administrator after new booking
10. Cost customisation page and Paypal and Sage payment system configuration. (Online payment is support at Premium, Premium Plus and Hotel Edition versions)
11. Paypal page for online payment after booking process
12. Days avalaibility customization page (setting available and unavailable days for booking resources) (This feature is support at Premium Plus and Hotel Edition versions)
13. Customization rates of booking resource depends from season. (For example: the cost of day can be higher at weekend)  (This feature is support at Premium Plus and Hotel Edition versions)
14. Setting cost, which is depends from number of selected days for booking  (This feature is support at Premium Plus and Hotel Edition versions)
15. Season filter page  (This feature is support at Premium Plus and Hotel Edition versions)
16. Booking widjets settings
17. Calendar skin - Traditional
18. Calendar skin - Traditional Light
19. Calendar skin - Standart
20. Calendar skin - Black
21. Calendar skin - Premium Marine (include to paid versions)
22. Calendar skin - Premium Black (include to paid versions)
23. Calendar skin - Premium Light (include to paid versions)
24. Calendar skin - Premium Steel (include to paid versions)
