    ...
    ?>
        <div class="booking-submenu-tab-container">
            <div class="nav-tabs booking-submenu-tab-insidecontainer">
                ...
                <a href="javascript:void(0)" onclick="javascript:makeScrollInAdminPanel('#bk_general_settings_main' );"
                   class="nav-tab booking-submenu-tab go-to-link" ><span><?php _e('Main', 'wpdev-booking');?></span></a>
                ...
                <fieldset>
                    <label for="booking_is_days_always_available" >                     
                        <input <?php if ($booking_is_days_always_available == 'On') echo "checked"; ?>  
                            ...
                            onclick="javascript: if (this.checked) { var answer = confirm('<?php  _e('Warning','wpdev-booking'); echo '! '; _e("You allow unlimited number of bookings per same dates, its can be a reason of double bookings on the same date. Do you really want to do this?", 'wpdev-booking'); ?>'); if ( answer){ this.checked = true; } else {this.checked = false;} }"                            
                          />
                        ...
                        <table class="form-table"><tbody>
                            ...
                            <tr valign="top">
                                ...
                                <td><fieldset><label for="booking_form_is_using_bs_css">
                                     ...
                                     <p class="description"><strong><?php _e('Note', 'wpdev-booking'); ?>:</strong> <?php _e('You must not deactivate loading BootStrap files at main section of these settings!', 'wpdev-booking'); ?></p>
                                </td>
                            </tr>                                    
                    ...
                    <table class="form-table email-table0" >
                        <tbody>
                            ...
                            <tr valign="top">
                                    ...
                                    <td><textarea id="email_deny_content" name="email_deny_content" style="width:100%;" rows="10"><?php echo ($email_deny_content); ?></textarea>
...
function email_help_section( $skip_shortcodes = array() , $email_example = '') {
        ?>
            <div class="wpbc-help-message" style="margin-top:10px;">
                ...
                <br/>
                <p class="description"><?php printf(__('In addition you can use these shortcodes', 'wpdev-booking'));?>: </p>
                <?php } else { ?>
                <p class="description"><?php printf(__('You can use in content of email template these shortcodes', 'wpdev-booking'));?>: </p>
                <?php }  ?>
                ...
                <?php } ?>
                <br/>
                <p class="description"><?php printf(__('Also you can use any HTML tags like this %s - to insert new line ', 'wpdev-booking'),'<code>&lt;br/&gt;</code>');?>, </p>
