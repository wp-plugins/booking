...
//debuge($sorted_structure);die;
            if (count($sorted_structure)>0) {
                ...
                <?php make_bk_action('show_booking_table_status_header'); ?>
                        <th style="width:70px;"><?php _e('Actions', 'wpdev-booking'); ?></th>
                    </tr>
                <?php }
...
<?php $is_can = apply_bk_filter('multiuser_is_user_can_be_here', true, 'not_low_level_user'); //Anxo customizarion
if ($is_can) { //Anxo customizarion ?>
        ...
        function show_footer_at_booking_page(){
            ...
            <div  class="copyright_info" style="">
                <div style="width:580px;height:10px;margin:auto;">
                    <div style="color:#999999; float:left; font-size:10px; margin:2px; line-height:14px; text-align:center; text-shadow:0 1px 0 #FFFFFF;">
                        <?php _e('More Information about this plugin can be found at the', 'wpdev-booking');?> <a href="http://onlinebookingcalendar.com/faq/" target="_blank" style="text-decoration:underline;color:#7F7DE4;">www.onlinebookingcalendar.com</a><br />
...
class BookingWidget extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p>
                    ...
                    <?php if (!class_exists('wpdev_bk_pro')) { ?>
                        <p>
                            <em><?php printf(__("%sImportant!!!%s Please note, %sseveral booking widgets supported only at %sPaid versions%s!!!%s At this version second widget is not show.", 'wpdev-booking'),'<strong>','</strong>','<span style="color:red;">','<a href="http://onlinebookingcalendar.com/" target="_blank">','</a>','</span>'); ?></em>
                        </p>
                    <?php
                    }
