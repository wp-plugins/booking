    ...
    function wpdevbk_show_help_dropdown_menu_in_top_menu_line() {
        ...
        <span class="dropdown pull-right">
            <a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle nav-tab "
               ><i class="icon-question-sign"></i> <?php /** ?><img class="menuicons" src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/<?php echo $my_icon; ?>"><?php /**/ 
                echo $title; ?> <b class="caret" style="border-top-color: #333333 !important;"></b></a>
...
//debuge($sql_start_select . $sql . $sql_where . $sql_order . $sql_limit);
        ...
        if ( false ) {
            // If we selected the Dates as "Today", then show only the bookings, where check in date is Today 
            if ( (isset($args['wh_booking_date'])) && ($args['wh_booking_date'] == '1') ) {
                ...
                <fieldset>
                    <label for="is_send_email_for_pending" style="display: inline-block;vertical-align: middle;margin: 10px 5px;color: #777777;"    >
                        <input type="checkbox" checked="CHECKED" id="is_send_email_for_pending" name="is_send_email_for_pending"  rel="tooltip" class="tooltip_top"  
                            data-original-title="<?php _e('Send email notification to customer after approval, cancelation or deletion of bookings'); ?>"
                ...
                <div class="wpdevbk-filters-section ">
                        ...
                        <form  name="booking_filters_form" action="" method="post" id="booking_filters_form"  class="form-inline">
                            ...
                            <a class="tooltip_top button button-primary" style="float: left; "
                               data-original-title="<?php _e('Refresh booking listing'); ?>"  rel="tooltip" 
                                href="javascript:void(0)"
                                onclick="javascript:booking_filters_form.submit();"
                                ><?php _e('Apply', 'wpdev-booking'); ?> <i class="icon-refresh icon-white"></i></a><a 
                                data-original-title="<?php _e('Reset filter to default values'); ?>"  rel="tooltip" 
...
//                            wpdevbk_checkboxbutton_filter($wpdevbk_id, $wpdevbk_selectors, $wpdevbk_control_label, $wpdevbk_help_block);
        ...
        function wpdev_show_booking_actions(){
            ...
            ?>
                <div class="btn-toolbar">
                    <div class="btn-group">
                        <a     data-original-title="<?php _e('Approve selected bookings'); ?>"  rel="tooltip" class="tooltip_top button button-primary"
                               onclick="javascript: 
                        ...
                        <a     data-original-title="<?php _e('Set selected bookings as pending'); ?>"  rel="tooltip" class="tooltip_top button button-secondary"
                               onclick="javascript: 
                    ...
                    <div class="btn-group" style="width:340px">
                        <a  data-original-title="<?php _e('Delete selected bookings'); ?>"  rel="tooltip" class="tooltip_top button button-secondary"
                            onclick="javascript: 
                        ...
                        <input  type="text" placeholder="<?php echo __('Reason for cancellation here', 'wpdev-booking'); ?>"
                                class="span3" value="" id="denyreason" name="denyreason" />
                    </div>

                    <div class="btn-group">
                        <a     data-original-title="<?php _e('Mark as read all bookings'); ?>"  rel="tooltip" class="tooltip_top button button-secondary"
                               onclick="javascript:
                        ...
                        <a     data-original-title="<?php _e('Mark as read selected bookings'); ?>"  rel="tooltip" class="tooltip_top button button-secondary"
                               onclick="javascript:
                                                    mark_read_booking( get_selected_bookings_id_in_booking_listing() ,
                                                          0, <?php echo $user_bk_id; ?>, '<?php echo getBookingLocale(); ?>' );
                               " /><?php _e('Read', 'wpdev-booking'); ?> <i class="icon-eye-close"></i></a>
                        <a     data-original-title="<?php _e('Mark as Unread selected bookings'); ?>"  rel="tooltip" class="tooltip_top button button-secondary"
                               onclick="javascript:                                       
                                                    mark_read_booking( get_selected_bookings_id_in_booking_listing() ,
    ...
    function booking_listing_table($bookings , $booking_types) {
        ...
        foreach ($bookings as $bk) {
          ...
          ?>" >
<?php if(0) { ?>
              <div class="wpbc_column_1 booking-listing-collumn span1 bktextcenter">
                  <input type="checkbox" class="booking_list_item_checkbox" 
                         ...
                         />&nbsp;&nbsp;&nbsp;
                  <span class="wpbc_mobile_legend clear"><?php _e('ID', 'wpdev-booking'); ?>: </span><span class="field-id"><?php echo $booking_id; ?></span>                  
                  <div class="field-date"><span class="wpbc_mobile_legend"><?php _e('Creation Date', 'wpdev-booking'); ?>:</span> <span><?php echo $cr_date; ?></span></div>
                  <span class="field-time"> <?php echo $cr_time; ?> </span>
              </div>

              <div class="wpbc_column_2 booking-listing-collumn span2 bktextleft booking-labels">
              ...
              <div class="wpbc_column_3 booking-listing-collumn span4 bktextjustify">
                    <div style="text-align:left"><?php echo $bk_form_show; ?></div>
              </div>

              <div class="wpbc_column_4 booking-listing-collumn span3 bktextleft booking-dates">
              ...
              <div class="wpbc_column_5 booking-listing-collumn span2 bktextcenter  booking-actions">
                  ...
                  <div class="actions-fields-group">
                   ...
                   ?><a  href="javascript:void(0)"  class="tooltip_bottom approve_bk_link button-secondary button  <?php if ($is_approved) echo ' hidden_items '; ?> "
                    ...
                    ><i class="icon-ok-circle"></i><?php
                        ...
                        href="javascript:void(0)"  class="tooltip_bottom pending_bk_link button-secondary button  <?php if (! $is_approved) echo ' hidden_items '; ?> "
                    ...
                    ><i class="icon-ban-circle"></i><?php
                        ...
                        class="tooltip_bottom button-secondary button"
