...
if (!function_exists ('debuge')) {
    function debuge() {
    	...
    	echo "<div style='border: 1px dashed #ff9933;font-size:11px;line-height:11px;font-family:'Lucida Grande',Verdana,Arial,'Bitstream Vera Sans',sans-serif;'><pre>"; print_r ( $var ); echo "</pre></div>";
