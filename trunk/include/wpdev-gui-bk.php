    ...
    class wpdev_gui_bk {
        ...
        function on_admin_menu() {
            ...
            switch ( $this->menu_type ) {
                case 'dashboard' :  $this->pagehook = add_dashboard_page ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='index'; break;
                case 'posts' :      $this->pagehook = add_posts_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='edit'; break;
                case 'media' :      $this->pagehook = add_media_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='upload'; break;
                case 'links' :      $this->pagehook = add_links_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='link-manager'; break;
                case 'pages' :      $this->pagehook = add_pages_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='edit-pages'; break;
                case 'comments' :   $this->pagehook = add_comments_page  ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='edit-comments'; break;
                case 'theme' :      $this->pagehook = add_theme_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='themes'; break;
                case 'users' :      $this->pagehook = add_users_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='users'; break;
                case 'management' : $this->pagehook = add_management_page( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='tools'; break;
                case 'options' :    $this->pagehook = add_options_page   ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='options-general'; break;
                case 'submenu' :    $this->pagehook = add_submenu_page($this->parent_page, $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page')  ); $this->icon_name='options-general';break;
                case 'object':      $this->pagehook = add_object_page( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page'), $icon_url  ); $this->icon_name='options-general';break;
                default: $this->pagehook = add_menu_page( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page'), $icon_url  ); $this->icon_name='options-general';
            }
