...
if (!class_exists('wpdev_gui_bk')) {
    ...
    class wpdev_gui_bk {
        ...
        function wpdev_gui_bk($gui_html_id, $file_path, $page_title, $menu_title, $menu_type = '', $icon_name='',$page_parent='', $user_level = 8) {
            ...
            $this->pagehook = 'init_page_hook';
            if ($icon_name!=='')       $this->icon_url = $icon_name ;
            if ($page_parent!=='')     $this->parent_page = $page_parent ;
            //add_action('admin_menu', array(&$this, 'on_admin_menu')); // this call back is not working correctly in PHP4 so needs to call it from parent class
        }
        ...
        // Setter for PageHook
        function setPageHook( $myPageHook ){
            $this->pagehook = $myPageHook;
        }
        ...
        function on_admin_menu() {
            ...
            switch ( $this->menu_type ) {
                case 'dashboard' :  $pagehook = add_dashboard_page ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='index'; break;
                case 'posts' :      $pagehook = add_posts_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='edit'; break;
                case 'media' :      $pagehook = add_media_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='upload'; break;
                case 'links' :      $pagehook = add_links_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='link-manager'; break;
                case 'pages' :      $pagehook = add_pages_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='edit-pages'; break;
                case 'comments' :   $pagehook = add_comments_page  ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='edit-comments'; break;
                case 'theme' :      $pagehook = add_theme_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='themes'; break;
                case 'users' :      $pagehook = add_users_page     ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='users'; break;
                case 'management' : $pagehook = add_management_page( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='tools'; break;
                case 'options' :    $pagehook = add_options_page   ( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page') ); $this->icon_name='options-general'; break;
                case 'submenu' :    $pagehook = add_submenu_page($this->parent_page, $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page')  ); $this->icon_name='options-general';break;
                case 'object':      $pagehook = add_object_page( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page'), $icon_url  ); $this->icon_name='options-general';break;
                default: $pagehook = add_menu_page( $this->page_title, $this->menu_title, $this->user_level, $this->file_path . $this->gui_html_id_prefix, array(&$this, 'on_show_page'), $icon_url  ); $this->icon_name='options-general';
            }
            $this->setPageHook($pagehook);
                ...
                <div id="poststuff" class="metabox-holder has-right-sidebar">
                    ...
                    <div id="post-body" class="has-sidebar">
                        <div id="post-body-content" class="has-sidebar-content">
                            ...
                            <p style="float:right;">
                                <input type="submit" value="<?php _e('Save'); ?>" class="button-primary" name="Submit"/>
                            </p>
                        </div>
                    </div>
                    <br class="clear"/>
