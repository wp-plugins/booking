...
function wpbc_define_top_menu_settings_for_sync_gcal() {
    ...
    $wpbc_settings[50]->add_sub_menu( array(
                                            'selected' => true
                                          , 'title' => __('Google Calendar', 'wpdev-booking')  .' ' . __('Feeds', 'wpdev-booking')   .' ' . __('Import', 'wpdev-booking')   
    ...
    ?>
     ...
     <div class='meta-box' style="">                
        <div <?php $my_close_open_win_id = 'bk_settings_gcal_sync'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');"><br></div>
            <h3 class='hndle'><span><?php _e('Google Calendar Feeds - General Settings', 'wpdev-booking'); ?></span></h3>          
       <div class="inside" style="margin:0px;">
        ...
        <table class="visibility_gcal_feeds_settings form-table settings-table">
            <tbody>
                ...
                <tr valign="top">
                    <th scope="row"><label for="booking_gcal_feed" ><?php _e('Feed URL', 'wpdev-booking'); ?>:</label></th>
                    <td class="wpdevbk">
     ...
     <div class='meta-box' style="">                
        <div <?php $my_close_open_win_id = 'bk_settings_gcal_sync_help'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');"><br></div>
            <h3 class='hndle'><span><?php _e('Google Calendar Feeds - Help Info', 'wpdev-booking'); ?></span></h3>          
       <div class="inside" style="margin:0px;">
        
            <div class="wpbc-help-message" style="margin-top:10px;">                
                <p class="description">
                    <strong><?php _e('To get Google Calendar Feed URL please follow this instruction', 'wpdev-booking');?></strong>                

                    <p class="wpdevbk"><?php 
                        printf(__('Set Google Calendar Address similar to this: %s or this %s', 'wpdev-booking')
                                ,'<code>https://www.google.com/calendar/feeds/your-email@group.calendar.google.com/public/basic</code><br>'
                                ,'<code>https://www.google.com/calendar/feeds/your-email@group.calendar.google.com/private-002635ede567431255ff274247f90746/basic</code>');                                                
                  ?></p>

                    <ul style="list-style:  disc;margin-left: 20px;">
                        <li><?php printf(__('Go to Google Calendar by clicking %s. Login to your Google account if you are not already logged in.', 'wpdev-booking'),'<a href="https://www.google.com/calendar" target="_blank">https://www.google.com/calendar</a>');?></li>
                        <li><?php printf(__('At the left side near specific calendar click expand (down arrow) icon to show menu and select Calendar Settings.', 'wpdev-booking'));?></li>
                        <li><?php printf(__('Find "Calendar Address" or "Private Address" and copy XML URL of specific calendar.', 'wpdev-booking'));?></li>
                    </ul>                    
                </p>
            </div>  
    ...
    <div id="wpbc_gcal_import_events" class="modal" style="display:none;width:59%;" >
       ...
       <div class="modal-body">
        ...
        <div class="modal-footer" style="text-align:center;"> 
         ...
         <?php } else { ?>
         <a href="javascript:void(0)" class="btn btn-primary"  style="float:none;"                                        
         ...
         <?php } ?>   
         <a href="javascript:void(0)" class="btn" style="float:none;" data-dismiss="modal"><?php _e('Close','wpdev-booking'); ?></a>
       </div>
    </div>
    <div class="btn-group">                            
