...
if (!defined('WP_BK_USE_TITLES_IN_EMAILS'))             define('WP_BK_USE_TITLES_IN_EMAILS',  true );            // If true,  then system try to send emails in format "Jo Smith" <josmith@server.com>  If false,  then  system  try to send emails in format josmith@server.com Some servers does not support or generate issues for first email  format.

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//   SYSTEM  CONSTANTS                        //////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if (!defined('WP_BK_VERSION_NUM'))      define('WP_BK_VERSION_NUM',     '5.4.3' );
