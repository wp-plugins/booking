...
//TODO: 
//  Set export functionality of emeil and other info
                    ...
                    foreach ($result as $bk) {
                        ...
                        ?>
                            <tr id="booking_row<?php  echo $bk->booking_id  ?>"  <?php if ($_GET['booking_id_selection'] ==$bk->booking_id) echo ' class="raw_after_editing" '; ?>  >
                                ...
                                <td <?php echo $alternative_color; ?> > <?php $cont = get_form_content($bk->form, $bk_type); ?>
...
function get_form_content ($formdata, $bktype =-1 ) {
    ...
    return ( array('content' => $booking_form_show, 'email' => $email_adress, 'name' => $name_of_person , 'visitors' => $visitors_count ) );
}
