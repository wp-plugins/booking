 ...
 * NEXT Releases FEATURES
 -----------------------------------------
 * Divide day to the parts according to the booking time
 * Booking for the specific range of days
 *
 * Captcha to the form
 * Translation to other languages
 * Skin customization PRO VERSION
 */


function wpdev_bk_define_static() {
    if (!defined('WPDEV_BK_VERSION'))    define('WPDEV_BK_VERSION',  '1.1' );                                // 0.1
    ...
    <tr>
       ...
       // Print     J a v a S cr i p t   &    C S S    scripts for admin and client side.
        ...
        function wpdev_booking_activate() {
           ...
           add_option( 'booking_title_after_reservation' , __('Thank you for your online reservation request. <br/> We will make contact to confirm your booking as soon as possible.') );
    ...
    switch ( $action ) :
        ...
        case  'INSERT_INTO_TABLE':
            ...
            <script type="text/javascript">
               ...
               jQuery('.submiting_content').fadeOut(7000);
