 ...
 * Add to Professional version posibility to set pending days for selection by other visitors, untill admin will not approve them.
 * Add posibility to make reservation of free spaces (rooms) from Hotel Edition version depends from number of visitors selection inside of Booking form.
 * Showing time in  AM/PM format inside of select boxes, something like this: [select starttime  "10:00pm"<22:00> "10:30pm"<22:30> "11:00pm"<23:00> "11:30pm"<23:30>  ]
 * Paypal pro integration
 *
 *  Right now I have in plans feature for admin of site to send emails to the visitors, which made reservations, with a link for payment. So you will have posibility to no show payment button during initial booking and then admin, after approve of booking, will send link to visitor for making payment.
 * Add default value for checkboxes
    ...
    <div style="width:35%; float:left;">
        ...
        <div class='meta-box'>
            <div  class="postbox gdrgrid" > <h3 class='hndle'><span><?php _e('Recomended WordPress Plugins','wpdev-booking'); ?></span></h3>
                <div class="inside">
                    <h2 style="margin:10px;"><?php _e('Customers &amp; Orders Support - show all old bookings'); ?> </h2>
                    <img src="<?php echo WPDEV_BK_PLUGIN_URL . '/img/crm-48x48.png'; ?>" style="float:left; padding:0px 10px 10px 0px;">
                ...
                <?php printf(__('This wordpress plugin is  %sshow all approved and pending bookings from past%s. Show how many each customer is made bookings. Paid versions support %sexport to CSV, print loyout, advanced filter%s. ','wpdev-booking'),'<strong>','</strong>','<strong>','</strong>'); ?> <br/>
                    ...
                    <p style="text-align:center;padding:10px 0px;">
                        <a href="http://wordpress.org/extend/plugins/orders" class="button-primary" target="_blank">Download from wordpress</a>
