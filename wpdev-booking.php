 ...
 * Coupon discount systems - a way to have discounts? like customers enter a promo code and they get some soft of discounts
 ...
 *
 *
 * send to wpdev, and onl.net
 * send to premium and hotel and bkman test sites
 * test at all tests sites
 * prepare for wp update
 *
 ...
 * Calculation of final cost based on % from the number of selected days for booking (option "togather" at the payemnt configuration settings page, where cost depends from number of selected days ) (Premium Plus, Hotel Edition)
