 ...
 * More advances pricing system: 5 day discount, check box for extra fees (insurance, extra towels)
...
function wpdev_bk_define_static() {
    if (!defined('WPDEV_BK_VERSION'))    define('WPDEV_BK_VERSION',  '1.5' );                             // 0.1
                    ...
                    <form  name="post_option" action="" method="post" id="post_option" >
                        <table class="form-table"><tbody>
                                ...
                                <tr valign="top"> <td colspan="2">
                                    <div style="width:100%;">
                                        <a href="#atogle_settings_thankyou" name="atogle_settings_thankyou"
                                    ...
                                    <table id="togle_settings_thankyou" style="display:none;width:100%;background: #f9f9f9;padding:0px 10px;width:auto;">
                                        <tr>
                                            <th>
                                ...
                                <tr valign="top"> <td colspan="2"> 
                                    <div style="width:100%;">
                                        <a href="#atogle_settings_unavailable" name="atogle_settings_unavailable"
                                    ...
                                    <table id="togle_settings_unavailable" style="display:none;width:100%;background: #f9f9f9;padding:0px 10px;width:auto;">
                                        <tr valign="top">
                                ...
                                <tr valign="top">
                                    <td colspan="2"><div style="width:100%;">
                                        <a href="#atogle_settings_useraccess" name="atogle_settings_useraccess" 
                                    ...
                                    <table id="togle_settings_useraccess" style="display:none;width:100%;background: #f9f9f9;padding:0px 10px;width:auto;">
                                        <tr valign="top">
