 ...
 * add shortcode for showing only calendar from pages / posts
 ...
 * Optimize CSS style for shoeing booking form
 * New title icons
...
<script type="text/javascript">jWPDev('#help_screeen_pro').animate({opacity:1},5000).fadeOut(2000);</script>
                <?php/**/
                echo '<div style="float:right;height:24px;padding:0px;font-size:12px;font-weight:bold;line-height:24px;margin:0px 5px;" id="bk_type_plus"><div style="float:left;width:auto;height:20px; padding:0px 3px; vertical-align:top;"><a href="#" onMouseDown="alert(\'This functionality exist at the paid versions, please purchase Booking Calendar Professional, Premium or Hotel Edition.\');" style="border-color:#455;border:2px solid #899 ;padding:3px 13px 3px 13px;"   class="bktypetitle" >+ '.__('Add new booking resource', 'wpdev-booking').'  </a></div></div>';
//              echo '<div style="float:right;height:24px;padding:0px 2px 0px;font-size:12px;font-weight:bold;line-height:50px;" id="bk_type_plus"><a href="#" onMouseDown="alert(\'This functionality exist at the paid versions, please purchase Booking Calendar Professional, Premium or Hotel Edition.\');" style="border-color:#455;border:2px solid ;padding:3px 13px 3px 35px; "   class="bktypetitle" ><div style="font-size:17px;float:left;margin:0px -34px 0px 0px;padding:0 0 0 20px;">+</div> '.__('Add new booking resource', 'wpdev-booking').'  </a></div>';
