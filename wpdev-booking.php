...
<a href="admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-option&tab=form" class="bk_top_menu <?php echo $slct_a; ?>"><?php _e('Form fields and content', 'wpdev-booking'); ?></a> |
            <?php if ($_GET['tab'] == 'email') { $slct_a = 'selected'; } else { $slct_a = ''; } ?>
<a href="admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-option&tab=email" class="bk_top_menu <?php echo $slct_a; ?>"><?php _e('Emails', 'wpdev-booking'); ?></a>

<?php if ( ($version == 'free') || ($version == 'premium') || ($version == 'hotel') ) { ?>
            <?php if ($_GET['tab'] == 'paypal') { $slct_a = 'selected'; } else { $slct_a = ''; } ?>
| <a href="admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-option&tab=paypal" class="bk_top_menu <?php echo $slct_a; ?>"><?php _e('Paypal and cost', 'wpdev-booking'); ?></a>
            <?php
 }
if ( ($version == 'free') || ($version == 'hotel') ) {
if ($_GET['tab'] == 'hotel') { $slct_a = 'selected'; } else {$slct_a = '';} ?>
| <a href="admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-option&tab=hotel" class="bk_top_menu <?php echo $slct_a; ?>"><?php _e('Booking resources', 'wpdev-booking'); ?></a>
<?php if ($_GET['tab'] == 'filter') { $slct_a = 'selected'; } else {$slct_a = '';} ?>
| <a href="admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-option&tab=filter" class="bk_top_menu <?php echo $slct_a; ?>"><?php _e('Season filers', 'wpdev-booking'); ?></a>
<?php
 }
        }
