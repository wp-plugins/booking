 ...
 * a way to have discounts? like customers enter a promo code and they get some soft of discounts
 ...
 * Ability to see the calculated price wen filling out the form (in the client side) * Let the customer see the price of their reservation before they have to fill in all their info
 * Insert Agregation calendar, this calendar have own booking resourse, but make unavailable some days based on resources from other calendars [booking type=1 agregation=1,2,5 ]
 ...
 * Fixing some errors during calulation of cost, which is depends from the number of selected days for booking, and based on %   (Premium Plus, Hotel Edition)
...
//debuge('$sorted_structure',$sorted_structure);             die;
            ...
            if (count($sorted_structure)>0) {
                ...
                ?><div style="float:right;">
                            <span  class="showwidedates<?php echo $short_days_class; ?>" style="cursor: pointer;text-decoration: none;font-size:10px;" onclick="javascript:
                               ...
                               "><img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/arrow-left.png" width="16" height="16" style="margin:0 5px -4px 0;"><?php _e('Wide days view', 'wpdev-booking'); ?><img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/arrow-right.png" width="16" height="16"  style="margin:0 0px -4px 5px;"></span>
                            <span class="showshortdates<?php echo $wide_days_class; ?>" style="cursor: pointer;text-decoration: none;font-size:10px;"  onclick="javascript:
                               ...
                               "><img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/arrow-right.png" width="16" height="16" style="margin:0 5px -4px 0;"><?php _e('Short days view', 'wpdev-booking'); ?><img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/arrow-left.png" width="16" height="16"  style="margin:0 0px -4px 5px;"></span>
                            </div>
                        </th>
                ...
                foreach ($sorted_structure as $bk) {
                    ...
                    if( $this->wpdev_bk_pro !== false ) { ?>
                                     <a href="javascript:;" onclick='javascript:location.href=&quot;admin.php?page=<?php echo WPDEV_BK_PLUGIN_DIRNAME . '/'. WPDEV_BK_PLUGIN_FILENAME ; ?>wpdev-booking-reservation&booking_type=<?php echo $bk['booking_type']; ?>&booking_hash=<?php echo $bk['hash']; ?>&quot;;'><img  src="<?php  echo  WPDEV_BK_PLUGIN_URL . '/img/edit_type.png'; ?>" class="tipcy" title='<?php echo __('Edit reservation','wpdev-booking'); ?>' /></a>
                        <?php } else { ?>
        ...
        function content_of_booking_page () {
            ...
            if ( ! isset($_GET['booking_sort_order']) ) {
                ...
                $booking_sort_order = get_option( 'booking_sort_order');
                $booking_sort_order_direction = get_option( 'booking_sort_order_direction');
            ...
            if ( ! isset($_GET['booking_type']) ) {
                $default_booking_resource = get_option( 'booking_default_booking_resource');
...
<div style="display:none;" id="wpdev-bk-dialog-container"><div id="wpdev-bk-dialog" ><div id="wpdev-bk-dialog-content" >
            ...
            <p style="line-height:25px;text-align:left;">You can test <a href="http://onlinebookingcalendar.com/demo/" target="_blank">online demo</a> of  "<strong class="color_premium0">Booking Calendar Premium</strong>" (<a href="http://onlinebookingcalendar.com/wp-admin/admin.php?page=booking/wpdev-booking.phpwpdev-booking" target="_blank">admin panel demo</a> )
or <a href="http://hotel.onlinebookingcalendar.com/" target="_blank">online demo</a> of  "<strong  class="color_hotel0">Booking Calendar Hotel Edition</strong>" (<a href="http://hotel.onlinebookingcalendar.com/wp-admin/admin.php?page=booking/wpdev-booking.phpwpdev-booking" target="_blank">admin panel demo</a> )</p>
...
text-shadow:-1px 1px 0 #FFFFFF;">
        ...
        <select id="admin_cal_count" name="admin_cal_count" onchange="setNumerOfCalendarsAtAdminSide(<?php echo get_current_user_id(); ?>,this.value);">
            <?php
    ...
    <div style="width:580px;height:10px;margin:auto;">
        ...
        function settings_menu_top_line() {
            ...
            <?php if ( ($version == 'free') || ($version == 'premium') || ($version == 'hotel') || ($version == 'premium_plus') ) { ?>
                ...
                $my_icon = 'Paypal-cost-64x64.png'; $my_tab = 'paypal';  ?>
            ...
            <?php if ( ($version == 'free') || ($version == 'hotel') || ($version == 'premium_plus') ) { ?>
                ...
                $my_icon = 'Booking-resources-64x64.png'; $my_tab = 'hotel';  ?>
        ...
        function settings_menu_content() {         
            ...
            if   ( ! isset($_GET['tab']) )  { $this->settings_general_content(); return; }
        ...
        function showUpgradeWindow($version) {
            ?>
                <div class='meta-box'>
                        <div <?php $my_close_open_win_id = 'bk_general_settings_upgrade'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="gdrgrid postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');"><br></div>
        ...
        function settings_general_content() {
            ...
            if ( isset( $_POST['start_day_weeek'] ) ) {
                ...
                update_option( 'booking_sort_order',$booking_sort_order);
                update_option( 'booking_sort_order_direction',$booking_sort_order_direction);
...
<form  name="post_option" action="" method="post" id="post_option" >
    ...
    <div  style="width:64%; float:left;margin-right:1%;">
        ...
        <div class='meta-box'>
            ...
            foreach ( $date_formats as $format ) {
                ...
                if ( get_option('booking_date_format') === $format ) {  
    ...
    <div class="clear" style="height:10px;"></div>
        ...
        function showBuyWidow() {
            ?>
                <div class='meta-box'>
                    <div  class="postbox gdrgrid" > <h3 class='hndle'><span><?php _e('Professional / Premium / Premium + / Hotel Ed. versions', 'wpdev-booking'); ?></span></h3>
                        <div class="inside">
                ...
                echo '</div><div style="clear:both;height:10px;"></div>';
                    ...
                    ?>
                        ...
                        switch ($_GET['tab']) {
                            ...
                            case 'paypal':?> <img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/help/booking_payment_pro.png" style="margin:0px 0px 20px auto;" ><?php break;
                            case 'hotel': ?> <img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/help/booking_rates_pro.png" style="margin:0px 0px 20px auto;" >  <?php break;
...
//$start_script_code .= "<style type='text/css'> .tooltips{ font-family:Arial; font-size:12px; font-weight:normal;  line-height:16px; } </style>";
        ...
        function wpdev_booking_activate() {
            ...
            add_option( 'booking_skin', WPDEV_BK_PLUGIN_URL . '/css/skins/traditional.css');
            
            add_option( 'booking_sort_order','id');
            add_option( 'booking_sort_order_direction', 'ASC');
            ...
            if ( ( strpos($_SERVER['SCRIPT_FILENAME'],'ordersplugin.onlinebookingcalendar.com') !== FALSE ) || ( strpos($_SERVER['HTTP_HOST'],'onlinebookingcalendar.com') !== FALSE ) ) {
            ...
            if( $this->wpdev_bk_pro !== false ) 
                add_option( 'booking_email_approval_content',htmlspecialchars(sprintf(__('Your reservation %s for: %s has been approved.%sYou can edit this booking at this page: %s Thank you, %s', 'wpdev-booking'),'[bookingtype]','[dates]','<br/><br/>[content]<br/><br/>', '[visitorbookingediturl]<br/><br/>' , $blg_title.'<br/>[siteurl]')));
            else add_option( 'booking_email_approval_content',htmlspecialchars(sprintf(__('Your reservation %s for: %s has been approved.%sThank you, %s', 'wpdev-booking'),'[bookingtype]','[dates]','<br/><br/>[content]<br/><br/>',$blg_title.'<br/>[siteurl]')));
        ...
        function wpdev_booking_deactivate() {
            ...
            if ($is_delete_if_deactive == 'On') {
                ...
                delete_option( 'booking_sort_order');
                delete_option( 'booking_sort_order_direction');
...
//adebug($my_dates4emeil);
            ...
            if ($my_booking_id>0) { // For editing exist booking
                ...
                if (get_option( 'booking_is_email_modification_adress'  ) != 'Off') {
                    ...
                    $mail_recipient =  htmlspecialchars_decode( get_option( 'booking_email_reservation_adress') );
                    if ( ( strpos($mail_recipient,'@blank.com') === false ) && ( strpos($mail_body_to_send,'admin@blank.com') === false ) )
                        if ($is_send_emeils != 0 )
                            @wp_mail($mail_recipient, $mail_subject, $mail_body_to_send, $mail_headers);
                }
