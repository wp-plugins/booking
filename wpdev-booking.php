...
= 1.5 =
 * Hotel edition version, posibility to set maximum number of items inside of booking resource. For exmaple maximum number of rooms of the specific type(booking resource). which will be vailable untill all rooms will be reserved.
...
function add_bk_filter($filter_type, $filter){  global $wpdev_bk_filter;
...
function remove_bk_filter($filter_type, $filter){  global $wpdev_bk_filter;

    if ( isset($wpdev_bk_filter[$filter_type]) ) {
        for ($i = 0; $i < count($wpdev_bk_filter[$filter_type]); $i++) {
            if ( $wpdev_bk_filter[$filter_type][$i][0] == $filter ) { $wpdev_bk_filter[$filter_type][$i] = null; return; }
        }
    }
}

function apply_bk_filter($filter_type){  global $wpdev_bk_filter;
...
function make_bk_action($action_type){  global $wpdev_bk_action;
    ...
    if ( is_array($wpdev_bk_action) )
        if ( isset($wpdev_bk_action[$action_type]) )
            foreach ($wpdev_bk_action[$action_type] as $action){
                ...
                $parameter = $action;
                call_user_func_array($action_func,$parameter );
            }
}

function add_bk_action($action_type, $action){  global $wpdev_bk_action;
...
function remove_bk_action($action_type, $action){  global $wpdev_bk_action;

    if ( isset($wpdev_bk_action[$action_type]) ) {
        for ($i = 0; $i < count($wpdev_bk_action[$action_type]); $i++) {
            if ( $wpdev_bk_action[$action_type][$i][0] == $action ) { $wpdev_bk_action[$action_type][$i] = null; return; }
        }
    }
}
/**/
...
//$this->createCaptha(); die;
	...
	function js_escape($text) {
        ...
        // Get dates  // TODO here aditional checking for free and busy days depends from max caount of items inside of booking resources.
        function get_dates ($approved = 'all', $bk_type = 1) {
           ...
           if ($approved == 'all')
            ...
            $dates_approve = apply_bk_filter('get_bk_dates', $wpdb->get_results( $sql_req ) );
        ...
        function createCapthaContent($bk_tp){
            if (  get_option( 'booking_is_use_captcha' ) !== 'On'  ) return '';
                    ...
                    $filename = $prefix . '.png';
                    $captcha_url = WPDEV_BK_PLUGIN_URL . '/include/captcha/tmp/' .$filename;
        ...
        function content_of_settings_page () {
           ...
           if ($is_show_settings) {
                    ...
                    if ( isset( $_POST['start_day_weeek'] ) ) {
                        ...
                        if ( ($_SERVER['HTTP_HOST'] == 'onlinebookingcalendar.com') || ($_SERVER['HTTP_HOST'] == 'www.onlinebookingcalendar.com') ) {
                                                ...
                                                <table class="form-table"><tbody>
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <td>    <div style="float:left;width:100px;border:0px solid red;">
                                                                    ...
                                                                    <span class="description"><?php _e('Saturday', 'wpdev-booking'); ?></span>
                                                                     ...
                                                                     <div style="float:left;width:70%;padding:0px 10px;style:0px solid red;">
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="description"><?php _e('Select user access level for this administration page', 'wpdev-booking');?></span>
                                                                <?php if ( ($_SERVER['HTTP_HOST'] == 'onlinebookingcalendar.com') || ($_SERVER['HTTP_HOST'] == 'www.onlinebookingcalendar.com') ) { ?> <br/><span class="description" style="font-weight: bold;">You do not allow to change this items because right now you test DEMO</span> <?php } ?>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div class="table">
                                            <table><tbody>
                                                ...
                                                <tr class="last">
                                                    ...
                                                    <td class="t comparision"><a href="http://onlinebookingcalendar.com/" target="_blank"><?php _e("visit", 'wpdev-booking'); ?></a></td>
                                                </tr>
                                                <tr class="last">
                                        ...
                                        <div class="table">
                                            <table><tbody>
                                                ...
                                                <tr class="first">
                                                    ...
                                                    <td class="t options"><a href="http://onlinebookingcalendar.com/" target="_blank"><?php _e("visit", 'wpdev-booking'); ?></a></td>
                                                </tr>
                                                <tr>
