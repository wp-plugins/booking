 ...
 * Mail:
    ...
    * New request emeil of payment sending by admin * Send emails to the visitors, which made reservations, with a link for payment. So you will have posibility to no show payment button during initial booking and then admin, after approve of booking, will send link to visitor for making payment.
