 ...
 * Add multilanguage support (dynamic changing languages, translation of booking calendar, at frontend side of site) using "WPML Multilingual CMS" plugin ( wpml.org ).
